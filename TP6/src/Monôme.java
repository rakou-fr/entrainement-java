public class Monôme {
     ...
     */
    public Monôme(float coefficient, int exposant)
     ...
     *                                    si les exposants des 2 monômes ne sont
     *                                    pas les mêmes
     */
    public Monôme somme(Monôme m) throws ArithmeticException {
        if (this.getExposant() != m.getExposant()) {
            throw new ArithmeticException(
                    "coefficient des deux monômes différents");
        }
        return new Monôme(this.getCoefficient() + m.getCoefficient(),
                this.getExposant());
    }
     ...
     * @return monôme résultat
     */
    public Monôme produit(Monôme m) {
        return new Monôme(this.getCoefficient() * m.getCoefficient(),
     ...
     * @return monôme résultat
     */
    public Monôme dérivée() {
        if (this.getExposant() == 0) {
            return new Monôme(0.0F, 0);
        } else {
            return new Monôme(this.getCoefficient() * this.getExposant(),
                    this.getExposant() - 1);
        }
    }
